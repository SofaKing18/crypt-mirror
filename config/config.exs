...
config :rocket_crypt, ecto_repos: [RocketCrypt.Repo]
...
config :rocket_crypt, RocketCryptWeb.Endpoint,
  ...
  pubsub: [name: RocketCrypt.PubSub, adapter: Phoenix.PubSub.PG2]

# Configure rocket crypt sync rates
config :rocket_crypt, crypt: ~w(BTC ETH BCH)a
